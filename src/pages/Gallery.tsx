        ...
        <div className="container mx-auto px-4">
            ...
            <div className="flex space-x-4 bg-muted p-2 rounded-lg">
              {categories.map((category) => (
                <button
                  ...
                  className={`px-6 py-2 rounded-md transition-all duration-300 hover-scale ${
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredItems.map((item, index) => (
              <div
                key={item.id}
                className="group bg-background border border-border rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover-lift animate-fade-in"
